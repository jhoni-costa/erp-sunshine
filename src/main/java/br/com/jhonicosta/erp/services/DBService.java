...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoria1.getProdutos().addAll(Arrays.asList(prod1, prod2, prod3, prod4));
		categoria2.getProdutos().addAll(Arrays.asList(prod2));
		categoria3.getProdutos().addAll(Arrays.asList(prod3, prod4, prod5));
		...
		prod4.setCategorias(Arrays.asList(categoria1, categoria3));
		prod5.setCategorias(Arrays.asList(categoria3));
...
//		Estado TO = new Estado(null, "Tocantins", "TO");
		...
		Endereco endereco7 = new Endereco(null, "Maria Brunatto Cantador", "530", null, araucaria, "Palamar",
				"83704383", TipoEndereco.RESIDENCIAL);
		endereco7.setUsuario(user1);
		user1.setEnderecos(Arrays.asList(endereco7));

		Endereco endereco8 = new Endereco(null, "Maria Brunatto Cantador", "531", null, araucaria, "Palamar",
				"83704383", TipoEndereco.RESIDENCIAL);
